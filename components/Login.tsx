                ...
                <div>
                    ...
                    <div className="relative group">
                        ...
                        <button
                            ...
                            className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 focus:text-blue-500 focus:outline-none p-1 rounded-full hover:bg-slate-100 transition-colors"
