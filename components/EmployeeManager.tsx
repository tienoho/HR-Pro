      ...
      {isEditing && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
              <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200">
                  ...
                  <form id="emp-form" onSubmit={handleSubmit} className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                          ...
                          <input id="emp-code" type="text" value={currentEmp.code} onChange={e => setCurrentEmp({...currentEmp, code: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" placeholder="NV001" required aria-required="true" />
                      </div>
                      <div>
                          <label htmlFor="emp-machine-id" className="block text-sm font-medium text-slate-700 mb-1">Mã chấm công (Machine ID) <span className="text-red-500">*</span></label>
                          <input id="emp-machine-id" type="text" value={currentEmp.timekeepingId} onChange={e => setCurrentEmp({...currentEmp, timekeepingId: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" placeholder="101" required aria-required="true" />
                      </div>
                      <div className="md:col-span-2">
                          ...
                          <input id="emp-name" type="text" value={currentEmp.name} onChange={e => setCurrentEmp({...currentEmp, name: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nguyễn Văn A" required aria-required="true" />
                      </div>
                      <div>
                       ...
                       <div>
                          ...
                          <input id="emp-pos" type="text" value={currentEmp.position} onChange={e => setCurrentEmp({...currentEmp, position: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" />
                      </div>
                      <div>
                          <label htmlFor="emp-join-date" className="block text-sm font-medium text-slate-700 mb-1">Ngày vào làm</label>
                          <input id="emp-join-date" type="date" value={currentEmp.joinDate} onChange={e => setCurrentEmp({...currentEmp, joinDate: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" />
                      </div>
                      <div>
                  ...
                  <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3 sticky bottom-0 z-10">
                      ...
                      <button type="submit" form="emp-form" className="px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-bold flex items-center gap-2 shadow-md shadow-blue-200"><Check size={18}/> Lưu Hồ Sơ</button>
                  </div>
              </div>
          </div>
      )}
