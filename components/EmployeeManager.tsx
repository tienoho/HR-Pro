              ...
              <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200">
                  ...
                  <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                          ...
                          <input id="emp-code" type="text" value={currentEmp.code} onChange={e => setCurrentEmp({...currentEmp, code: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" placeholder="NV001" />
                      </div>
                      <div>
                          <label htmlFor="emp-machineId" className="block text-sm font-medium text-slate-700 mb-1">Mã chấm công (Machine ID) <span className="text-red-500">*</span></label>
                          <input id="emp-machineId" type="text" value={currentEmp.timekeepingId} onChange={e => setCurrentEmp({...currentEmp, timekeepingId: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" placeholder="101" />
                      </div>
                      <div className="md:col-span-2">
                          ...
                          <input id="emp-name" type="text" value={currentEmp.name} onChange={e => setCurrentEmp({...currentEmp, name: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nguyễn Văn A" />
                      </div>
                      <div>
