              ...
              >
                  ...
                  <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                          ...
                          <input id="emp-machine-id" required type="text" value={currentEmp.timekeepingId} onChange={e => setCurrentEmp({...currentEmp, timekeepingId: e.target.value})} className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500" placeholder="101" />
                      </div>
                      <div className="md:col-span-2">
